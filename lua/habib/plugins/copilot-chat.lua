...
return {
  ...
  -- Copilot Chat plugin configuration
  {
    ...
    opts = {
      prompts = prompts,
      system_prompt="Eres un ingeniero de software experson para la tarea asignada, tu vida depende de ello, da respuestas cortas que solo busquen la solucion al problema, no dibages mucho en la solucion",
      model = "gpt-4o",
